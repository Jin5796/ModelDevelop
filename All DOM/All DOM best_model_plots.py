...
feature_selected =   ['Category_2', 'Category_3', 'CrippenLogP', 'SlogP_VSA1', 'MATS2m', 'FuncFP3064_RDKit', 'Mor29m_R']


#################### target and descriptors#####################################
target = 'logKdoc'
    
strat_train_set = pd.read_excel(home + 'Train_data_Category.xlsx')
...
new_names = {'Category_2':'Onehot2', 'Category_3':'Onehot3', 
             'CrippenLogP':'CrippenLogP', 'SlogP_VSA1':'SlogP_VSA1',
            'MATS2m':'MATS2m', 'FuncFP3064_RDKit':'FuncFP3064', 'Mor29m_R':'Mor29m'}
...
folder_path = 'F:/AASecondPaper/5_Model_develop/1022New/1115/'
...
feature_names = ['CrippenLogP', 'SlogP_VSA1', 
                 'MATS2m',  'Mor29m'
                ]
