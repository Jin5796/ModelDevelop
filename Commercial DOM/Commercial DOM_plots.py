...
model = GradientBoostingRegressor(random_state=123,n_estimators= 100,
                                  ...
                                  min_samples_leaf =1,
                                  subsample= 0.8) 
feature_selected =   ['CrippenLogP', 'MATS2m', 'PatternFP730_RDKit', 'FuncFP3064_RDKit', 'Mor29m_R']
...
strat_train_set = pd.read_excel(home + 'Train_commercial.xlsx')
strat_test_set = pd.read_excel(home + 'Test_commercial.xlsx')
...
new_names = {
             'CrippenLogP':'CrippenLogP', 'FuncFP3064_RDKit':'FuncFP3064',
...
feature_names = ['CrippenLogP', 'MATS2m',   'Mor29m']
