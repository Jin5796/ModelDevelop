...
feature_selected =   ['CrippenLogP', 'SlogP_VSA1', 'MATS2m', 'PatternFP730_RDKit', 'Mor29m_R']


target = 'logKdoc'
strat_train_set = pd.read_excel(home + 'Train_aquatic.xlsx')
strat_test_set = pd.read_excel(home + 'Test_aquatic.xlsx')
...
folder_path = 'F:/AASecondPaper/5_Model_develop/1022New/Aquatic/1115/'
...
feature_names = ['CrippenLogP', 'SlogP_VSA1', 'MATS2m',   'Mor29m']
